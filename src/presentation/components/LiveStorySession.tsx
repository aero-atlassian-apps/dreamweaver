...
import { Button } from './ui/Button'; // Assuming shadcn or similar
...
export const LiveStorySession: React.FC<LiveStorySessionProps> = ({ childName, childAge }) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center p-8 space-y-6 bg-gradient-to-b from-slate-900 to-slate-800 rounded-xl shadow-2xl border border-white/10">
            {/* Header */}
