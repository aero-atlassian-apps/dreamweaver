...
const PERSONAS = [
    ...
    { id: 'en-GB-Neural2-A', name: 'Custom (Clone)', gender: 'Any', desc: 'Ready | Awaiting Google "Instant Custom Voice" (Chirp 3) Allowance', color: 'bg-green-500/20 text-green-300', icon: 'graphic_eq' },
]
...
const THEMES: { value: DemoTheme; label: string; emoji: string }[] = [
    ...
    { value: 'magic', label: 'Magic', emoji: 'âœ¨' },
                                        ...
                                        {history.map((story) => (
                                            ...
                                            >
                                                <div className="h-12 w-12 rounded-xl bg-white/5 flex items-center justify-center text-2xl">
                                                    {THEME_IMAGES[story.theme] ? (story.theme === 'space' ? 'ðŸš€' : story.theme === 'ocean' ? 'ðŸŒŠ' : 'âœ¨') : 'ðŸ“–'}
                                                </div>
                                                <div className="flex-1 min-w-0">
                                                    <h3 className="font-semibold text-white truncate">{story.title}</h3>
                                                    <p className="text-xs text-white/50 truncate">
                                                        {new Date(story.createdAt).toLocaleDateString()} â€¢ {story.theme}
                                                    </p>
                                                </div>
                                        ...
                                        <div className="space-y-6">
                                            ...
                                            <div className="flex gap-3 pt-4">
                                                ...
                                                <Button
                                                    ...
                                                    className="flex-[2]"
                                                >
                                                    {loading ? 'Loading...' : 'Start Story âœ¨'}
                                                </Button>
                                            </div>
                                            ...
                                            {narrationData?.hasAudio && narrationData.audioUrl ? (
                                                    ...
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <div className="flex-1">
                                                            <div className="flex justify-between text-sm mb-2">
                                                                <span className="text-white/70">ðŸŽ§ Audio Narration</span>
                                                ...
                                                <Card variant="solid" padding="md" className="text-center">
                                                    <p className="text-white/50 text-sm">
                                                        ðŸ“– Text story generated â€¢ Audio requires GOOGLE_TTS_API_KEY
                                                    </p>
                                                </Card>
                                            )}
                                    ...
                                    {step === 'complete' && (
                                        <div className="space-y-6 text-center">
                                            <div className="py-8">
                                                ...
                                                <h1 className="text-3xl font-bold font-serif mb-2">Golden Moment Captured! âœ¨</h1>
                                            ...
                                            <Card variant="interactive" padding="lg" className="border-primary/30">
                                                <h3 className="font-semibold mb-2">ðŸš€ Ready for the full experience?</h3>
                ...
                <section id="verdict" className="min-h-[50vh] py-24 px-4 flex flex-col items-center justify-center bg-black/40 relative z-10">
                    <div className="max-w-2xl w-full space-y-8 text-center animate-fade-in">
                        <div className="inline-block p-3 rounded-full bg-white/5 border border-white/10 mb-4">
                            <span className="text-4xl">ðŸ‘¨â€âš–ï¸</span>
                        </div>
